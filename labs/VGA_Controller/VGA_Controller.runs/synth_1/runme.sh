...
HD_PWD='F:/My_sem_10/sem10_my_material/MICRO_LAB/labs/VGA_Controller/VGA_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_IMAGE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_IMAGE.tcl
