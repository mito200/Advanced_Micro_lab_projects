...
set_property used_in_implementation false [get_files C:/Vivado2020.1/Basys-3-Master.xdc]

set_param ips.enableIPCacheLiteLoad 1
close [open __synthesis_is_running__ w]

OPTRACE "synth_design" START { }
synth_design -top VGA_IMAGE -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef VGA_IMAGE.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file VGA_IMAGE_utilization_synth.rpt -pb VGA_IMAGE_utilization_synth.pb"
