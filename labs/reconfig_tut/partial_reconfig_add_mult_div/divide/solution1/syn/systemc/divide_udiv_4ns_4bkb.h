...
// ==============================================================
#ifndef __divide_udiv_4ns_4bkb__HH__
#define __divide_udiv_4ns_4bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(divide_udiv_4ns_4bkb) {
    ...
    SC_CTOR(divide_udiv_4ns_4bkb):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
