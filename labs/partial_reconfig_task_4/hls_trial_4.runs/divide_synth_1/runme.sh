...
HD_PWD='F:/My_sem_10/sem10_my_material/MICRO_LAB/hls_trial_4/hls_trial_4.runs/divide_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divide.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divide.tcl
